...
const {BASE,SPACE,LIMITS,TECH,physical,mappedPlan,evaluate,dominates,pareto,rng}=require('../src/search/k3_architecture_search.js');
const {simulate,MiB}=require('../src/simulation/k3_operator_sram_sim.js');
...
const data=JSON.parse(fs.readFileSync('data/search/k3_architecture_search_results.json','utf8'));
...
const html=fs.readFileSync('reports/search/k3_architecture_search_report.html','utf8'),els={};
