...
const doc=fs.readFileSync(path.join(root,'docs/design/20_INDUSTRIAL_AGENT_ORGANIZATION.md'),'utf8');
const catalog=JSON.parse(fs.readFileSync(path.join(root,'data/analysis/teams/industrial_agent_organization.json'),'utf8'));
for(const name of ['hardware','software','model']) assert(fs.existsSync(path.join(root,'docs/design/teams',name,'README.md')));
