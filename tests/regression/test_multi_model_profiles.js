...
const profilePath = path.join(root, 'teams/model/inputs/model_profiles.json');
...
const multiModelDoc = fs.readFileSync(path.join(root, 'docs/architecture/13_MULTI_MODEL_ARCHITECTURE.md'), 'utf8');
for (const required of ['GLM-5.2', 'DeepSeek-V4-Pro', 'TP-only', 'MTP_ROLLBACK', 'index cache', '384 expert']) {
