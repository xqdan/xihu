'use strict';
const fs=require('fs'),assert=require('assert'),O=require('../../integration/detailed/k3_rdma_final_tuning_model.js');
const d=require('../../out/rdma/k3_rdma_final_tuning_results.json'),b=d.search.best;
...
assert(!/NaN|undefined|Infinity/.test(fs.readFileSync('out/rdma/k3_rdma_final_tuning_report.html','utf8')));
...
const src=fs.readFileSync('integration/detailed/k3_rdma_final_tuning_model.js','utf8');
...
assert(O.OPT.chargeSharedPortCost===true);const P=require('../../integration/detailed/k3_physical_basis.js'),p0=P.resize(A.physical(b.x));
