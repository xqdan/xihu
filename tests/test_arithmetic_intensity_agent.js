...
const doc = fs.readFileSync(path.join(root, 'docs/design/16_ARITHMETIC_INTENSITY_AGENT.md'), 'utf8');
const contract = JSON.parse(fs.readFileSync(path.join(root, 'data/analysis/arithmetic_intensity_contract.json'), 'utf8'));
