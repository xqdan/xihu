...
const matrix=read('teams/model/inputs/model_manifest_qualification_matrix.json');
const contract=read('out/contracts/model_workload_contract.json');
...
assert.strictEqual(contract.qualificationMatrix,'teams/model/inputs/model_manifest_qualification_matrix.json');
