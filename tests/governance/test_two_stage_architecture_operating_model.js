...
const doc=fs.readFileSync(path.join(root,'teams/council/docs/17_TWO_STAGE_ARCHITECTURE_OPERATING_MODEL.md'),'utf8');
const c=JSON.parse(fs.readFileSync(path.join(root,'teams/council/inputs/architecture_stage_operating_model.json'),'utf8').replace(/^\uFEFF/,''));
