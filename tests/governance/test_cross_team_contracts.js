...
const model=read('out/contracts/model_workload_contract.json');
const hw=read('out/contracts/hardware_resource_contract.json');
const sw=read('out/contracts/software_execution_contract.json');
const integration=read('out/contracts/integration_manifest.json');
