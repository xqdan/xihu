...
const gate=read('data/governance/gate_status.json');assert.strictEqual(gate.quantificationGate.decision,'BLOCKED_BY_D_GATE_MANIFEST_EVENT_MODEL_AND_PROVENANCE');assert.strictEqual(gate.quantificationGate.evidenceKind,'SYNTHETIC_BOTTLENECK_BOUND');
