...
- `teams/vv/ARCHITECTURE_TESTPLAN.md`
- `teams/vv/GOLDEN_TRACE_SPEC.md`
- `teams/vv/REQUIREMENT_TRACEABILITY.md`
- `teams/vv/PPA_THERMAL_SIGNOFF_PLAN.md`
...
> 2026-09-25 注：下面是 2026-09-21 提出的目标文档树，不是仓库当前布局。当前布局（`teams/`、`integration/`、`out/`、`docs/`、`archive/`）见根目录 `README.md`；验证证据在 `teams/vv/` 与 `tests/`，ADR 在 `teams/council/adr/`。

```text
docs/chip_design/
├── HIGH_LEVEL_ARCHITECTURE.md       # 本文：总纲和文档地图
├── 00_CURRENT_STATE.md              # 当前基线、证据等级和阻塞项
├── DECISIONS.md                     # ADR 决策记录（现为 teams/council/adr/）
