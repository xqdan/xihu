...
规格空间来源：工作区 `docs/1000tps/k3_1000tps_chip_designs.html`（Kimi K3、目标 1000 TPS/usr 的芯片规格搜索页）
...
| B-002 | MC 档位未选定：320 为基线，480 为默认上限，560/640 为激进 | 998.81 TPS 使用 640 GB/s，不能作为承诺；1M、16 卡路线 A 约 883 TPS | 选定颗数与每颗带宽的供应商规格 |
