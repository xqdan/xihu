const fs=require('fs');
const org=JSON.parse(fs.readFileSync('data/analysis/teams/industrial_agent_organization.json','utf8'));
...
fs.writeFileSync('data/analysis/teams/industrial_agent_detail.json',JSON.stringify(out,null,2)+'\n');
