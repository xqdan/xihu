 ...
 * card) are preserved.
 *
 * Run after `npm run search:final`: node integration/pipelines/sync_baseline_spec.js
 */
const fs = require('fs');
...
const results = read('out/rdma/k3_rdma_final_tuning_results.json');
...
spec.modelResults = {
  profile: 'P1-compact-executable',
  source: 'out/rdma/k3_rdma_final_tuning_results.json',
...
write('teams/hardware/inputs/k3_mc_baseline.json', spec);

// Directional workload baseline: the K3 calibration block mirrors the MC320 point.
const baseline = read('out/direction/directional_workload_baseline.json');
