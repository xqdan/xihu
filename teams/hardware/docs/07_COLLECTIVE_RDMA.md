...
> [`docs/architecture/21_TPS_DESIGN_BASELINE.md`](../../../docs/architecture/21_TPS_DESIGN_BASELINE.md) 第 2.2、4.2、4.3 节。
...
和 collective 串行时间以 `out/rdma/k3_rdma_final_tuning_results.json#/search/best`
