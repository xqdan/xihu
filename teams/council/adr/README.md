...
| 编号 | 旧编号 | 决策 | 日期 | 状态 |
|---|---|---|---|---|
| [ADR-0001](ADR-0001-exploratory-stage-b-tp-sweep.md) | — | D-Gate 阻塞时只允许探索性 Stage B TP Sweep | 2026-09-21 | Accepted |
...
| [ADR-0012](ADR-0012-compute-die-candidate.md) | ADR-004 | Compute Die 候选 | 2026-09-20（2026-09-23 补充） | `MODEL` |
...
| [ADR-0018](ADR-0018-7-reticle-package-boundary.md) | ADR-010 | 7-reticle 单芯片物理边界 | 2026-09-21 | `BASELINE` |
