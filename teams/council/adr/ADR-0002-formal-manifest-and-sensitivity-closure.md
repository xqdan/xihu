...
- 范围：K3、GLM-5.2、DeepSeek-V4-Pro；P1（唯一硬件规格，ADR-0021）；MC320/MC640；TP8/TP16/TP32
...
4. 保留 MC320/MC640 和 TP8/TP16/TP32 的独立维度，不把 stretch profile 当成 baseline（硬件规格维度已由 ADR-0021 收敛为 P1）。
