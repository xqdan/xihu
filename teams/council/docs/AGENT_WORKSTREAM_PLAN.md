...
```text
docs/architecture/00_CURRENT_STATE.md
...
```text
docs/architecture/scaleout/
docs/architecture/collective/
src/rdma/
...
tests/
.github/workflows/
docs/architecture/REQUIREMENT_TRACEABILITY.md
```
