...
| 模型基座 | `integration/detailed/k3_rdma_final_tuning_model.js`、`integration/detailed/k3_sram_memory_rdma_model.js`、`integration/detailed/k3_operator_sram_sim.js`、`teams/model/src/design_engine.js#kimiK3` |
...
| 基线 | TPS | 融合后 | ΔTPS |
|---|---:|---:|---:|
| 发布候选 `out/rdma/k3_rdma_final_tuning_results.json#search.best.x` | 859.18 | **886.85** | +27.67 |
